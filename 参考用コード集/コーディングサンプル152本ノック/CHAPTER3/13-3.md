...
```swift
  <div class="container">
    ...
    <form action="#">
      ...
      <fieldset class="form__item">
        <legend class="form__ttl">生年月日<span class="label-any">任意</span></legend>
        <div class="form__body">
...
legend.form__ttl { /*legend要素のデフォルト位置から下にずらす*/
	margin-bottom: 5px;
	transform: translateY(1.5em);
}
@media screen and (min-width: 768px),print {
	.form__item::after { /*clearfixでfloat解除*/
		content: "";
		display: block;
		clear: both;
	}
	.form__ttl {
		float: left; /*fieldsetはtable・flex・grid効かないため*/
		width: 30%;
	}
	.form__body {
		width: 70%;
	...
	legend.form__ttl {
		transform: translateY(0); /*legend要素の位置戻す*/
	}
}
