...
<img src="images/9798be37-f986-4e1a-a9ab-ef1e6a675374-0.jpg" width="500">
...
Webサーバーは、**クッキーが以前送ったものと同じかどうかを確認して**、同じものであれば以前アクセスしてきたWebブラウザーだと判断する。  
この様な仕組みによって、**会員制サイトのログイン状態を維持したり、ショッピングサイトでカートに入れた商品が会計時まで保存したりできる**。  

そのほかにも、**ユーザーのアクセス履歴を取得して「トラッキング」やユーザー行動の分析といった用途にも使用される**。  
そのためプライバシー保護の一環でクッキーの利用を制限している地域や国もある。  
